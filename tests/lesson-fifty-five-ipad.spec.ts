...
async function openLesson55(page:Page){
  ...
  await expect(lesson55).toBeEnabled();await expect(lesson55).toHaveClass(/is-interactive/);await expect(lesson56).toBeEnabled();await expect(lesson57).toBeDisabled();
