...
async function openLesson55(page:Page){
  ...
  await expect(lesson55).toBeEnabled();await expect(lesson55).toHaveClass(/is-interactive/);await expect(lesson56).toBeEnabled();await expect(lesson57).toBeEnabled();await expect(lesson58).toBeEnabled();await expect(lesson59).toBeEnabled();await expect(lesson60).toBeEnabled();await expect(lesson61).toBeEnabled();await expect(lesson62).toBeDisabled();
