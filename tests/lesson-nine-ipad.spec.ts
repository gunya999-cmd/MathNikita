...
const answers:Record<string,Answer>={
  'l9-diagnostic':{type:'choice',value:'ломаную ABCD'},
  'l9-segment-part':{type:'input',value:'23'},
  'l9-polyline-length':{type:'input',value:'32'},
  'l9-units':{type:'choice',value:'AB и NP'},
  'l9-practice1':{type:'input',value:'71'},
  'l9-practice2':{type:'input',value:'16'},
  ...
  'l9-challenge':{type:'order',values:['Получить 8 см как 13 − 5','Получить 3 см как 8 − 5','Получить 2 см как 5 − 3','Получить 1 см как 3 − 2']},
};
...
test('lesson 9 completes every exercise and produces full scores on iPad WebKit',async({page})=>{
