...
test('lesson 167 remains usable on iPad without horizontal overflow',async({page})=>{
  await page.goto('/');
  ...
  await page.evaluate(()=>window.dispatchEvent(new CustomEvent('mathnikita-go-to-stage',{detail:{lessonNumber:167,stageIndex:6}})));
