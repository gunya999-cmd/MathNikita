...
const readyDescriptions:Record<number,string>={
  ...
  19:'Повторение главы 1 перед контрольной № 1: все шесть тем, стратегия самопроверки и 12-задательная генеральная репетиция.',
  20:'Контрольная работа № 1: 8 заданий по структуре методического пособия, 14 оцениваемых подпунктов и разбор только после сдачи.',
  21:'Новая тема § 7: слагаемые и сумма, поразрядное сложение многозначных чисел, переносы и проверка результата.',
  22:'Свойства сложения: переместительное и сочетательное свойства, удобные вычисления, буквенные выражения и составные величины.',
  23:'Закрепление § 7: самостоятельный выбор удобного порядка сложения, буквенные выражения, составные величины и текстовые задачи.',
  24:'Итог § 7: обобщение сложения и его свойств, выбор стратегии, текстовые задачи, самостоятельный контроль и задача повышенной сложности.',
  25:'Новая тема § 8: вычитание как действие, обратное сложению, компоненты действия, письменное вычитание, размен разрядов, проверка сложением и первые задачи.',
  ...
  28:'Прикидка суммы и разности: округление до удобного разряда, оценка порядка результата, границы и поиск невозможных ответов.',
};
  ...
  return <main className="course-catalog-page">
    ...
    <section className="course-catalog-toolbar" aria-label="Поиск урока">
      <div>
        ...
        <span>Полностью готовы 28 интерактивных уроков. Остальные сохранены в точной последовательности учебного года.</span>
      </div>
      <label>
