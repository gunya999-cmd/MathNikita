...
export const yearPlan=baseYearPlan.map(lesson=>lesson.number===83?{...lesson,title:'Объём: обратные и составные задачи',available:true}:lesson.number===84?{...lesson,title:'Объём: итоговое обобщение',available:true}:lesson.number===85?{...lesson,title:'Комбинаторные задачи: систематический перебор',available:true}:lesson.number<=85?{...lesson,available:true}:{...lesson,available:false});
