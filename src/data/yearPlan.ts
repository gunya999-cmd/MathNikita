...
export const yearPlan=ready152.map(lesson=>lesson.number===153?{...lesson,title:'Итог §38: составные задачи на нахождение числа по процентам',available:true}:lesson.number===154?{...lesson,title:'Повторение §36–§38: среднее арифметическое и проценты',available:true}:lesson.number===155?{...lesson,title:'Подготовка к контрольной №9: среднее арифметическое и проценты',available:true}:lesson.number===156?{...lesson,title:'Контрольная работа № 9: среднее арифметическое и проценты',available:true}:lesson);
