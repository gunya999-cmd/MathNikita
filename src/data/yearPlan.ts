...
export const yearPlan=ready152.map(lesson=>lesson.number===154?{...lesson,title:'Повторение §36–§38: среднее арифметическое и проценты',available:true}:lesson.number===153?{...lesson,available:false}:lesson);
