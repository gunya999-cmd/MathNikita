...
export const extendedPracticeByLesson: Record<number, ExtendedPracticeSet> = Object.fromEntries(
  Object.entries(basePracticeByLesson).map(([key,practice])=>{
    ...
    const masteryTasks=lessonNumber===5?lessonFiveMastery:lessonNumber===6?lessonSixMastery:lessonNumber===9?lessonNineMastery:buildMasteryPractice(lessonNumber);
