...
function correct(field:ControlField,response:string){return[field.answer,...(field.accepted??[])].some(answer=>semanticAnswersEquivalent(String(response),String(answer)))}
