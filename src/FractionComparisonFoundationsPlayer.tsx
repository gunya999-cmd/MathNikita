...
const conceptStages:Stage[]=[
  ...
  {id:'l96-boundary',eyebrow:'Переменная',title:'Граница проходит там, где числитель равен знаменателю',body:'Если неизвестный числитель обозначить словом «икс», правильная дробь получается, пока икс меньше знаменателя. Первое натуральное значение икс, при котором дробь становится неправильной, равно знаменателю. Если икс стоит в знаменателе, условие неправильной дроби меняется: знаменатель икс не должен превышать числитель.',note:'Эта логика позволит решать задания с неизвестным числителем или знаменателем без латинских обозначений в озвучке.'},
