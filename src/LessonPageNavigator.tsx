...
const pagesByLesson:Record<number,PageItem[]>={
  ...
  17:lessonSeventeenStages,18:lessonEighteenStages,19:lessonNineteenStages,21:lessonTwentyOneStages,22:lessonTwentyTwoStages,23:lessonTwentyThreeStages,24:lessonTwentyFourStages,
};
const groupsByLesson:Record<number,PageGroup[]>={
  ...
  17:groups17,18:groups18,19:groups19,21:groups21,22:groups22,23:groups23,24:groups24,
};

function activeLessonNumber(){
  const text=document.querySelector<HTMLElement>('.lesson-mode-toolbar')?.textContent??'';
  for(let lessonNumber=24;lessonNumber>=2;lessonNumber-=1){
