...
["readyDescriptions[86]='Закрепление § 24: ограничения в дереве вариантов, ведущий ноль, порядок цифр, сумма и чётность суммы; маршрут №651, 653, 655, 656, 658 и повторение №670.';","readyDescriptions[86]='Закрепление § 24: ограничения в дереве вариантов, ведущий ноль, порядок цифр, сумма и чётность суммы; маршрут №651, 653, 655, 656, 658 и повторение №670.';\nreadyDescriptions[87]='Итог § 24: неупорядоченные пары, правило произведения, маршруты, оптимизация и логика; маршрут №659, 661, 663, 664, 666, 667 и дополнительная №673.';"],
